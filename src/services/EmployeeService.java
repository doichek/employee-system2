...
public class EmployeeService extends ServiceBase {
    ...
    public List<EmployeeView> getPerPage(int page) {
        List<Employee> employees = em.createNamedQuery("employee.getAll", Employee.class)
    ...
    public long countAll() {
        long empCount = (long) em.createNamedQuery("employee.count", Long.class)
                .getSingleResult();
    ...
    public List<String> update(EmployeeView ev, String pepper) {
        ...
        if (!savedEmp.getCode().equals(ev.getCode())) {//DB内の登録済み社員番号と入力フォームで入力している社員番号??で一致していなかったら更新作業??
            //社員番号を更新する場合
